...
FORCEINCLUDES= 
ifeq "$(CFG)" "debug"
DEFINES += -DVPC -DRAD_TELEMETRY_DISABLED -DDEBUG -D_DEBUG -DGNUC -DPOSIX -DCOMPILER_GCC -D_DLL_EXT=.so -D_LINUX -DLINUX -DPOSIX -D_POSIX -DDLLNAME=client -DBINK_VIDEO -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DUSE_SDL -DDEV_BUILD -DNO_STRING_T -DCLIENT_DLL -DVECTOR -DVERSION_SAFE_STEAM_API_INTERFACES -DPROTECTED_THINGS_ENABLE -Dstrncpy=use_Q_strncpy_instead -D_snprintf=use_Q_snprintf_instead -DENABLE_CHROMEHTMLWINDOW -DUSE_WEBM_FOR_REPLAY -DHL2MP -DHL2_CLIENT_DLL -D_EXTERNAL_DLL_EXT=.so -DVPCGAMECAPS=HL2MP -DPROJECTDIR=/home/wep/devel/darkness/mp/src/game/client -D_DLL_EXT=.so -DSOURCE1=1 -DVPCGAME=hl2mp -D_LINUX=1 -D_POSIX=1 -DLINUX=1 -DPOSIX=1 
else
...
CPPFILES= \
    ...
    WorldDimsProxy.cpp \
    ../shared/class_info.cpp \
    ../shared/item_info.cpp \
    ../shared/hl2mp/weapon_acid_gren.cpp \
    ../shared/hl2mp/weapon_breeder.cpp \
    ../shared/hl2mp/weapon_c4.cpp \
    ../shared/hl2mp/weapon_drone_slash.cpp \
    ../shared/hl2mp/weapon_engy.cpp \
    ../shared/hl2mp/weapon_engy_destroy.cpp \
    ../shared/hl2mp/weapon_guardian_gren.cpp \
    ../shared/hl2mp/weapon_guardian_slash.cpp \
    ../shared/hl2mp/weapon_hatchy.cpp \
    ../shared/hl2mp/weapon_plasma_canon.cpp \
    ../shared/hl2mp/weapon_plasma_rifle.cpp \
    ../shared/hl2mp/weapon_silenced_smg.cpp \
    ../shared/hl2mp/weapon_smk_gren.cpp \
    ../shared/hl2mp/weapon_stalker_slash.cpp \
    ../shared/hl2mp/weapon_stalker_gren.cpp \
    ../shared/hl2mp/weapon_stinger_fire.cpp \
    ../shared/ents/ammo_crate.cpp \
    ../shared/ents/detector.cpp \
    ../shared/ents/egg.cpp \
    ../shared/ents/ent_infested_corpse.cpp \
    ../shared/ents/exp_mine.cpp \
    ../shared/ents/gasser.cpp \
    ../shared/ents/healer.cpp \
    ../shared/ents/human_materiel.cpp \
    ../shared/ents/materiel.cpp \
    ../shared/ents/medipad.cpp \
    ../shared/ents/mg_turret.cpp \
    ../shared/ents/missile_turret.cpp \
    ../shared/ents/obstacle.cpp \
    ../shared/ents/pack_item.cpp \
    ../shared/ents/spider_materiel.cpp \
    ../shared/ents/spike.cpp \
    ../shared/ents/spiker.cpp \
    ../shared/ents/teleporter.cpp \
    nv_screeneffect.cpp \
    hud_assets.cpp \
    hud_iteminfo.cpp \
    hud_pack_item.cpp \
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/class_info.P
endif

$(OBJ_DIR)/class_info.o : $(PWD)/../shared/class_info.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/item_info.P
endif

$(OBJ_DIR)/item_info.o : $(PWD)/../shared/item_info.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_acid_gren.P
endif

$(OBJ_DIR)/weapon_acid_gren.o : $(PWD)/../shared/hl2mp/weapon_acid_gren.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_breeder.P
endif

$(OBJ_DIR)/weapon_breeder.o : $(PWD)/../shared/hl2mp/weapon_breeder.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/weapon_c4.o : $(PWD)/../shared/hl2mp/weapon_c4.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_drone_slash.P
endif

$(OBJ_DIR)/weapon_drone_slash.o : $(PWD)/../shared/hl2mp/weapon_drone_slash.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_engy.P
endif

$(OBJ_DIR)/weapon_engy.o : $(PWD)/../shared/hl2mp/weapon_engy.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_engy_destroy.P
endif

$(OBJ_DIR)/weapon_engy_destroy.o : $(PWD)/../shared/hl2mp/weapon_engy_destroy.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_guardian_gren.P
endif

$(OBJ_DIR)/weapon_guardian_gren.o : $(PWD)/../shared/hl2mp/weapon_guardian_gren.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_guardian_slash.P
endif

$(OBJ_DIR)/weapon_guardian_slash.o : $(PWD)/../shared/hl2mp/weapon_guardian_slash.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_hatchy.P
endif

$(OBJ_DIR)/weapon_hatchy.o : $(PWD)/../shared/hl2mp/weapon_hatchy.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_plasma_canon.P
endif

$(OBJ_DIR)/weapon_plasma_canon.o : $(PWD)/../shared/hl2mp/weapon_plasma_canon.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_plasma_rifle.P
endif

$(OBJ_DIR)/weapon_plasma_rifle.o : $(PWD)/../shared/hl2mp/weapon_plasma_rifle.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_silenced_smg.P
endif

$(OBJ_DIR)/weapon_silenced_smg.o : $(PWD)/../shared/hl2mp/weapon_silenced_smg.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_smk_gren.P
endif

$(OBJ_DIR)/weapon_smk_gren.o : $(PWD)/../shared/hl2mp/weapon_smk_gren.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_stalker_slash.P
endif

$(OBJ_DIR)/weapon_stalker_slash.o : $(PWD)/../shared/hl2mp/weapon_stalker_slash.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_stalker_gren.P
endif

$(OBJ_DIR)/weapon_stalker_gren.o : $(PWD)/../shared/hl2mp/weapon_stalker_gren.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_stinger_fire.P
endif

$(OBJ_DIR)/weapon_stinger_fire.o : $(PWD)/../shared/hl2mp/weapon_stinger_fire.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/nv_screeneffect.P
endif

$(OBJ_DIR)/nv_screeneffect.o : $(PWD)/nv_screeneffect.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/hud_assets.P
endif

$(OBJ_DIR)/hud_assets.o : $(PWD)/hud_assets.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/hud_iteminfo.P
endif

$(OBJ_DIR)/hud_iteminfo.o : $(PWD)/hud_iteminfo.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/hud_pack_item.P
endif

$(OBJ_DIR)/hud_pack_item.o : $(PWD)/hud_pack_item.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/hud_points.P
endif

$(OBJ_DIR)/hud_points.o : $(PWD)/hud_points.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/hud_spawns.P
endif

$(OBJ_DIR)/hud_spawns.o : $(PWD)/hud_spawns.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/buildmenu.P
endif

$(OBJ_DIR)/buildmenu.o : $(PWD)/game_controls/buildmenu.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/classmenu.o : $(PWD)/game_controls/classmenu.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/ammo_crate.P
endif

$(OBJ_DIR)/ammo_crate.o : $(PWD)/../shared/ents/ammo_crate.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/detector.P
endif

$(OBJ_DIR)/detector.o : $(PWD)/../shared/ents/detector.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/egg.P
endif

$(OBJ_DIR)/egg.o : $(PWD)/../shared/ents/egg.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/ent_infested_corpse.P
endif

$(OBJ_DIR)/ent_infested_corpse.o : $(PWD)/../shared/ents/ent_infested_corpse.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/exp_mine.P
endif

$(OBJ_DIR)/exp_mine.o : $(PWD)/../shared/ents/exp_mine.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/gasser.P
endif

$(OBJ_DIR)/gasser.o : $(PWD)/../shared/ents/gasser.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/healer.P
endif

$(OBJ_DIR)/healer.o : $(PWD)/../shared/ents/healer.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/human_materiel.P
endif

$(OBJ_DIR)/human_materiel.o : $(PWD)/../shared/ents/human_materiel.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/materiel.P
endif

$(OBJ_DIR)/materiel.o : $(PWD)/../shared/ents/materiel.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/medipad.P
endif

$(OBJ_DIR)/medipad.o : $(PWD)/../shared/ents/medipad.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/mg_turret.P
endif

$(OBJ_DIR)/mg_turret.o : $(PWD)/../shared/ents/mg_turret.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/missile_turret.P
endif

$(OBJ_DIR)/missile_turret.o : $(PWD)/../shared/ents/missile_turret.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/obstacle.P
endif

$(OBJ_DIR)/obstacle.o : $(PWD)/../shared/ents/obstacle.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/pack_item.P
endif

$(OBJ_DIR)/pack_item.o : $(PWD)/../shared/ents/pack_item.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/spider_materiel.P
endif

$(OBJ_DIR)/spider_materiel.o : $(PWD)/../shared/ents/spider_materiel.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/spike.P
endif

$(OBJ_DIR)/spike.o : $(PWD)/../shared/ents/spike.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/spiker.P
endif

$(OBJ_DIR)/spiker.o : $(PWD)/../shared/ents/spiker.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/teleporter.P
endif

$(OBJ_DIR)/teleporter.o : $(PWD)/../shared/ents/teleporter.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
